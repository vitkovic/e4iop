...
public class UserService {
    ...
    // private final PasswordEncoder passwordEncoder; for jwt - user/ password														
    ...
    /**
     * NOvi metod za registraciju sa strane za unos korisnika portala. Za sada je promenjena samo aktivacija
     * Ovde je automatski aktivan.
     * @param userDTO
     * @param password
     * @return
     */
    public User registerUserRiPortal(ManagedUserVM userDTO, String password) {
        userRepository.findOneByLogin(userDTO.getLogin().toLowerCase()).ifPresent(existingUser -> {
            boolean removed = removeNonActivatedUser(existingUser);
            if (!removed) {
                throw new UsernameAlreadyUsedException();
    ...
    private boolean removeNonActivatedUser(User existingUser) {
        ...
        portalUserRepository.deleteByUserId(existingUser);
    ...
    public User saveFromManagedUser(ManagedUserVM userDTO) {
    ...
    @Transactional
    public boolean isCurrentUserInRole(String... authorities) {
        log.debug("Request to check if current user has Authorities {} ", Arrays.toString(authorities));
        
        Optional<User> userOptional = this.getUserWithAuthorities();
        
        if (userOptional.isEmpty()) {
            String errorMessage = "User with authorities could not be found!";
            throw new EntityNotFoundException(errorMessage);
        }
        
        User user = userOptional.get();
        
        Set<String> authoritySet = new HashSet<>(Arrays.asList(authorities));
        
        return user.getAuthorities().stream()
                .anyMatch(userAuthority -> authoritySet.contains(userAuthority.getName()));
    }																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																				
}
