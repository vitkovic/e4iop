 ...
 */
  ...
  public hideAll(): void {
    console.log('hideAll method called');
    this.toggle = false;
  ...
  public changeNews(value, event): void {
    ...
    if (value != null && typeof value != 'undefined' && this.cmsnews.length > 0) this.showbutt = true;
    else this.showbutt = false;
  ...
  public changeQuestions(value, event): void {
    ...
    if (value != null && typeof value != 'undefined' && this.questions.length > 0) this.showbutt = true;
    else this.showbutt = false;
  ...
  public changeCompanies(value, event): void {
    ...
    if (value != null && typeof value != 'undefined' && this.companies.length > 0) this.showbutt = true;
    else this.showbutt = false;
