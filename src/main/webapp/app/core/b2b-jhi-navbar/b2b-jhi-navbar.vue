          ...
          <div class="col-sm-12 col-md-10">
            ...
            <div class="selInp">
              <b-input-group class="input-grupaC">
                ...
                <b-form-input class="inputPoljeC" type="text" :placeholder="$t('global.menu.searchAd')"></b-form-input>
                <div class="input-group-append">
                  <b-button class="primary btn btn-dark">{{ $t('entity.action.searchBar') }}</b-button>
                </div>
              </b-input-group>
            </div>
          </div>
