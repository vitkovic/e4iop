...
export default class ServiceProposal extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllServiceProposals();
  }
  ...
  public retrieveAllServiceProposals(): void {
    ...
    this.serviceProposalService()
      ...
      .then(
        res => {
          ...
          debugger;
          this.serviceProposalsDTO = res.data;
  ...
  public prepareRemove(instance: IServiceProposal): void {
  ...
  public removeServiceProposal(): void {
    this.serviceProposalService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('riportalApp.serviceProposal.deleted', { param: this.removeId });
  ...
  public like(proposal: any): void {
    this.isFetching = true;
    this.ServiceProposalsLikes.proposal = proposal;
    this.ServiceProposalsLikes.nlike = 1;
    this.ServiceProposalsLikes.ndislike = 0;
    this.serviceProposalService()
      .like(this.ServiceProposalsLikes)
      .then(res => {
  ...
  public dislike(proposal: any): void {
    this.isFetching = true;
    this.ServiceProposalsLikes.proposal = proposal;
    this.ServiceProposalsLikes.nlike = 0;
    this.ServiceProposalsLikes.ndislike = 1;
    this.serviceProposalService()
      .like(this.ServiceProposalsLikes)
      .then(res => {
        proposal.likes = res.likes;
