<template>
    <div class="mb-5">
        <b-row>
            ...
            <b-col sm="4"  class="text-right mb-4 mb-sm-0 mt-4 mt-sm-0">
        ...
        <b-row>
            <b-col cols="7" md="4" class="text-right mt-1">
        ...
        <div v-if="showDetails">
            <b-row class="mt-2">
                <b-col md="5" offset-md="1"  lg="3" offset-lg="3" class="mr-2" >
                    <b-row>
                    ...
                    <b-row class="mt-2 mb-2" v-for="status in infrastructureStatistic.infrastructureNumberDto.numberPerStatuses" :key="status.id">
                        <b-col cols="6" sm="8" class="text-right light-blue-color">
                            {{status.status.status}}:
                        </b-col>
                        <b-col cols="6" sm="4" class="text-right light-blue-color">
                            {{status.statusNumber}}
                        </b-col>
                    </b-row>                
                </b-col>
                <b-col md="5" lg="3"  class="mr-2">
                    <b-row>
                        <b-col sm="12" class="text-center" style="background-color:#143263; color:white">
        ...
        <b-row class="mt-2">
            <b-col cols="7" md="4" class="text-right">
