<template>
  <div>
    <router-link
      :to="{ name: 'AdvertisementSubsubcategoryCreate' }"
      tag="button"
      id="jh-create-entity"
      class="btn btn-primary float-right jh-create-entity create-advertisement-subsubcategory"
    >
    ...
    <h2 id="page-heading" class="mt-5">
      <span v-text="$t('riportalApp.advertisementSubsubcategory.home.title')" id="advertisement-subsubcategory-heading"
        >Advertisement Subsubcategories</span
      >
    </h2>
    <b-alert
    ...
    <div class="custom-table-responsive" v-if="advertisementSubsubcategories && advertisementSubsubcategories.length > 0">
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="advertisementSubsubcategory in advertisementSubsubcategories" :key="advertisementSubsubcategory.id">
            <td>
              <router-link
                :to="{ name: 'AdvertisementSubsubcategoryView', params: { advertisementSubsubcategoryId: advertisementSubsubcategory.id } }"
                class="text-body"
                >{{ advertisementSubsubcategory.id }}</router-link
              >
            </td>
              ...
              <div class="btn-group">
                <router-link
                  :to="{
                    ...
                    params: { advertisementSubsubcategoryId: advertisementSubsubcategory.id },
                  }"
                  tag="button"
                ...
                <b-button
                  v-on:click="prepareRemove(advertisementSubsubcategory)"
                  variant="danger"
                  class="btn btn-sm"
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="riportalApp.advertisementSubsubcategory.delete.question" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p
          id="jhi-delete-advertisementSubsubcategory-heading"
          v-text="$t('riportalApp.advertisementSubsubcategory.delete.question', { id: removeId })"
        >
          Are you sure you want to delete this Advertisement Subsubcategory?
        </p>
      </div>
...
<script lang="ts" src="./advertisement-subsubcategory.component.ts"></script>
