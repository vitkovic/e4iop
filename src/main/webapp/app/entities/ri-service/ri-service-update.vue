	        ...
	        <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="riportalApp.riService.home.createOrEditLabel" v-text="$t('riportalApp.riService.home.createOrEditLabel')">Create or edit a RiService</h2>
                 <div class="border border-primary basic-card">
                    ...
                    <b-form-row class="mt-4">
                        ...
                        <select class="form-control" id="ri-service-researchInfrastructure" name="researchInfrastructure" v-model="riService.researchInfrastructure" required :class="{'valid': !$v.riService.researchInfrastructure.$invalid, 'invalid': $v.riService.researchInfrastructure.$invalid }">
                    ...
                    <b-col cols="12" md="6" lg="3"  v-if="currentLanguage === 'sr' || currentLanguage === 'en'">
                        ...
                        <input type="text" class="form-control" name="nameSr" id="ri-service-nameSr" 
                            :class="{'valid': !$v.riService.nameSr.$invalid, 'invalid': $v.riService.nameSr.$invalid }" v-model="$v.riService.nameSr.$model" required/>
                    ...
                    <b-col cols="12" md="6" lg="3">
                        ...
                        <input type="text" class="form-control" name="nameEn" id="ri-service-nameEn"
                ...
                <b-form-row class="mt-4">
                    ...
                    <b-col cols="4" md="2" lg="1">
                        ...
                        <select class="form-control" id="ri-service-currency" name="currency" :class="{'valid': !$v.riService.currency.$invalid, 'invalid': $v.riService.currency.$invalid }"  v-model="$v.riService.currency.$model" :required="$v.riService.currency.$invalid">
                        ...
                        <div v-if="$v.riService.currency.$invalid">
                            <small class="form-text text-danger" v-if="!$v.riService.currency.required" v-text="$t('entity.validation.required')">This field is required.
                            </small>
                        </div>
                    </b-col>               
                    <b-col cols="12" md="6" lg="3">
                    ...
                    <b-col cols="12" md="6" lg="3">
                        ...
                        <div v-if="riService.accredation && riService.accredation.statusEn == serviceAccreditationOptions.ACCREDITED" sm="3">
                ...
                <b-form-row class="mb-4 mt-4">
                 ...
                 <div>
                    ...
                    <button type="submit" id="save-entity" :disabled="$v.riService.$invalid || isSaving" class="btn btn-primary">
               ...
               <div class="border border-primary basic-card">
                ...
                <div>
                    ...
                    <!-- :disabled="$v.riService.$invalid || isSaving" -->
                    <button type="submit" ref="form_submit" id="save-entity" :disabled="$v.riService.$invalid || isSaving"  class="btn btn-primary">
                        <font-awesome-icon icon="save"></font-awesome-icon>&nbsp;<span v-text="$t('entity.action.save')">Save</span>
                    </button>
                </div>
                </div>
