      ...
      <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th v-on:click="changeOrder('description')">
              <span v-text="$t('riportalApp.advertisement.description')">Description</span>
        ...
        <tbody>
          <tr v-for="advertisement in selectedAdvertisements" :key="advertisement.id">
            <td>
            ...
            <td>
              <router-link
                ...
                >{{ advertisement.title }}</router-link
              >
            </td>
            ...
            <td>
              <div v-if="advertisement.company">
                <router-link
                  ...
                  class="font-weight-normal text-body"
                  >{{ advertisement.company.name }}</router-link
                >
              </div>
            </td>
          </tr>
...
<script lang="ts" src="./advertisement-browse.component.ts"></script>
