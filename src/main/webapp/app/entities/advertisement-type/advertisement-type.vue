<template>
  <div>
    <router-link
      :to="{ name: 'AdvertisementTypeCreate' }"
      tag="button"
      id="jh-create-entity"
      class="btn btn-primary float-right jh-create-entity create-advertisement-type"
    >
    ...
    <div class="custom-table-responsive" v-if="advertisementTypes && advertisementTypes.length > 0">
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="advertisementType in advertisementTypes" :key="advertisementType.id">
            <td>
              <router-link
                :to="{ name: 'AdvertisementTypeView', params: { advertisementTypeId: advertisementType.id } }"
                class="text-body"
                >{{ advertisementType.id }}</router-link
              >
            </td>
            ...
            <td class="text-right">
              <div class="btn-group">
                ...
                <router-link
                  :to="{ name: 'AdvertisementTypeEdit', params: { advertisementTypeId: advertisementType.id } }"
                  tag="button"
                ...
                <b-button v-on:click="prepareRemove(advertisementType)" variant="danger" class="btn btn-sm" v-b-modal.removeEntity>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="riportalApp.advertisementType.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-advertisementType-heading" v-text="$t('riportalApp.advertisementType.delete.question', { id: removeId })">
          Are you sure you want to delete this Advertisement Type?
        </p>
      </div>
      <div slot="modal-footer">
        ...
        <button
          ...
          id="jhi-confirm-delete-advertisementType"
          v-text="$t('entity.action.delete')"
          v-on:click="removeAdvertisementType()"
        >
          Delete
        </button>
      </div>
...
<script lang="ts" src="./advertisement-type.component.ts"></script>
