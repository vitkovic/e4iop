<template>
  <div>
    <router-link
      :to="{ name: 'AdvertisementCategoryCreate' }"
      tag="button"
      id="jh-create-entity"
      class="btn btn-primary float-right jh-create-entity create-advertisement-category"
    >
    ...
    <div class="custom-table-responsive" v-if="advertisementCategories && advertisementCategories.length > 0">
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="advertisementCategory in advertisementCategories" :key="advertisementCategory.id">
            <td>
              <router-link
                :to="{ name: 'AdvertisementCategoryView', params: { advertisementCategoryId: advertisementCategory.id } }"
                class="text-body"
                >{{ advertisementCategory.id }}</router-link
              >
            </td>
            ...
            <td class="text-right">
              <div class="btn-group">
                ...
                <router-link
                  :to="{ name: 'AdvertisementCategoryEdit', params: { advertisementCategoryId: advertisementCategory.id } }"
                  tag="button"
                ...
                <b-button v-on:click="prepareRemove(advertisementCategory)" variant="danger" class="btn btn-sm" v-b-modal.removeEntity>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="riportalApp.advertisementCategory.delete.question" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-advertisementCategory-heading" v-text="$t('riportalApp.advertisementCategory.delete.question', { id: removeId })">
          Are you sure you want to delete this Advertisement Category?
        </p>
      </div>
      <div slot="modal-footer">
        ...
        <button
          ...
          id="jhi-confirm-delete-advertisementCategory"
          v-text="$t('entity.action.delete')"
          v-on:click="removeAdvertisementCategory()"
        >
          Delete
        </button>
      </div>
...
<script lang="ts" src="./advertisement-category.component.ts"></script>
