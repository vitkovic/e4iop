  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          v-if="cmsSliderTitleHasID === false"
          id="riportalApp.cmsQuestion.home.createTitleLabel"
          v-text="$t('riportalApp.cmsSlider.home.createTitleLabel')"
        >
          Create a CmsQuestion
        </h2>
        <h2 v-else id="riportalApp.cmsQuestion.home.editTitleLabel" v-text="$t('riportalApp.cmsSlider.home.editTitleLabel')">
          Edit a CmsQuestion
        </h2>
        <div>
          <div class="form-group" v-if="cmsSlider.id">
            <label for="id" v-text="$t('global.field.id')">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="cmsSlider.id" readonly />
          </div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              name="title"
              id="cms-slider-title"
              :class="{ valid: !$v.cmsSlider.title.$invalid, invalid: $v.cmsSlider.title.$invalid }"
              v-model="$v.cmsSlider.title.$model"
              required
            />
          ...
          <div class="form-group">
            ...
            <input
              ...
              name="link"
              id="cms-slider-link"
              :class="{ valid: !$v.cmsSlider.link.$invalid, invalid: $v.cmsSlider.link.$invalid }"
              v-model="$v.cmsSlider.link.$model"
              placeholder="Uneti link sa http:// ili https://"
              required
            />
          ...
          <div class="form-group">
            ...
            <input
              ...
              class="form-check"
              name="newTab"
              id="cms-slider-newTab"
              required
              :class="{ valid: !$v.cmsSlider.newTab.$invalid, invalid: $v.cmsSlider.newTab.$invalid }"
              v-model="$v.cmsSlider.newTab.$model"
            />
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('riportalApp.cmsSlider.ordinalNumber')" for="cms-slider-ordinalNumber"
            ...
            <input
              ...
              class="form-control"
              name="ordinalNumber"
              id="cms-slider-ordinalNumber"
              :class="{ valid: !$v.cmsSlider.ordinalNumber.$invalid, invalid: $v.cmsSlider.ordinalNumber.$invalid }"
              v-model.number="$v.cmsSlider.ordinalNumber.$model"
            />
          </div>
          ...
          <div class="documents-section">
            <div class="form-group row">
              <div class="col-xs-12 col-sm-6">
                <label
                  ...
                  v-text="$t('riportalApp.cmsSlider.imageUpload.title')"
                ></label>
                <b-form-file
                ...
                <div>
                  <p class="small mb-0 text-info" v-text="$t('riportalApp.cmsSlider.imageUpload.imgDimension')"></p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6">
                <div v-if="cmsSlider.image">
                  <p class="logo-img-label font-weight-bold" v-text="$t('riportalApp.cmsSlider.imageUpload.currentImage')">Current logo:</p>
                  <div class="mb-3 pl-1">
                    ...
                    <button
                      ...
                      v-on:click="openDeleteSliderImageModal()"
                      v-b-modal.deleteSliderImageModal
                    >
            ...
            <div v-if="sliderImage != null" class="mb-4">
              <p class="font-weight-bold" v-text="$t('riportalApp.cmsSlider.imageUpload.newImage')">New logo:</p>
              {{ sliderImage.name }}
    ...
    <b-modal ref="deleteSliderImageModal" id="deleteSliderImageModal">
      <span slot="modal-title" v-text="$t('riportalApp.cmsSlider.delete.title')"></span>
      <div class="modal-body">
        <p v-text="$t('riportalApp.cmsSlider.delete.questionImage')"></p>
      </div>
...
<script lang="ts" src="./cms-slider-update.component.ts"></script>
